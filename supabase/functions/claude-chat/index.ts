  ...
  try {
    ...
    const systemPrompt = [{
      ...
      text:
        ...
        "יש לך גישה לנתוני Google Search Console, Google Analytics 4 (כולל סשנים, משתמשים, המרות ומקורות תנועה דרך get_analytics_traffic ו-get_traffic_sources), נפחי חיפוש, ומיקומים בגוגל. " +
        "אם כלי מחזיר 'אין נתונים' או found=false, זה אומר שצריך לסנכרן את המקור - אמור זאת למשתמש; אל תאמר שאין לך גישה או חיבור לנתונים. " +
